...
#
image1 = imread("../../img/gs-blur-dd-male2.jpg", flatten=True)
image2 = imread("../../img/gs-blur-dd-male.jpg", flatten=True)
image3 = imread("../../img/gs-blur-dd-female.jpg", flatten=True)
